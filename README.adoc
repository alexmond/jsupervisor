...
image:https://codecov.io/gh/alexmond/jsupervisor/graph/badge.svg?token=NTBMWTYIBU[Code Coverage,link=https://codecov.io/gh/alexmond/jsupervisor]
...
This project provides a robust process supervision solution built with Spring Boot 3.x.
